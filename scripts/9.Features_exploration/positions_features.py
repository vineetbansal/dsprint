...
if __name__ == '__main__':
    ...
    domains_features_df.to_csv("positions_features_fixed.csv", sep='\t', index_label='')

    import hashlib
    assert hashlib.md5(open('positions_features_fixed.csv', 'rb').read()).hexdigest() == '12b1d00f8c803f70fc7f48a1c725f7fe'
